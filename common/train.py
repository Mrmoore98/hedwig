...
class TrainerFactory(object):
    ...
    trainer_map = {
        ...
        'ELEC':ClassificationTrainer,
    }

    @staticmethod
    def get_trainer(dataset_name, model, embedding, train_loader, trainer_config, train_evaluator, test_evaluator, dev_evaluator=None, config_main=None):
        ...
        return TrainerFactory.trainer_map[dataset_name](
            model, embedding, train_loader, trainer_config, config_main, train_evaluator, test_evaluator, dev_evaluator
        )
