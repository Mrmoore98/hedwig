...
from models.han_origin.args import get_args
from models.han_origin.model import HAN
...
if __name__ == '__main__':
    ...
    dataset_map[args.dataset].NESTING_FIELD = Field(batch_first=True, tokenize=Word_Tokenize(),  fix_length = None )
